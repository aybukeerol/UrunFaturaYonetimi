...
namespace UrunFaturaYonetimi
{
    public partial class MainForm : Form
    {
        ...
        private void DashboardAc()
        {
            ...
            int margin = 32;
            int availableWidth = Math.Max(900, pnlContent.ClientSize.Width - (margin * 2));
            ...
            welcome.Location = new Point(margin, 26);
            ...
            description.Location = new Point(margin + 2, 70);
            pnlContent.Controls.Add(description);

            TableLayoutPanel cards = new TableLayoutPanel();
            cards.Location = new Point(margin, 115);
            cards.Size = new Size(availableWidth, 122);
            ...
            Panel card1 = DashboardCard("Bugünkü Faturalar", AppData.Faturalar.Count.ToString(), 0, 0);
            Panel card2 = DashboardCard("Toplam Cari", AppData.Cariler.Count.ToString(), 0, 0);
            Panel card3 = DashboardCard("Toplam Ürün", AppData.Urunler.Count.ToString(), 0, 0);
            Panel card4 = DashboardCard("Favori Kayıtlar", FavoriSayisi().ToString(), 0, 0);
            ...
            card2.Margin = new Padding(4, 0, 8, 0);
            card3.Margin = new Padding(8, 0, 4, 0);
            card4.Margin = new Padding(12, 0, 0, 0);
            ...
            lblFavoriler.Location = new Point(margin, 270);
            pnlContent.Controls.Add(lblFavoriler);
            ...
            favoriAciklama.Location = new Point(margin + 2, 299);
            pnlContent.Controls.Add(favoriAciklama);

            FlowLayoutPanel favoriPanel = new FlowLayoutPanel();
            favoriPanel.Location = new Point(margin, 330);
            favoriPanel.Size = new Size(availableWidth, 100);
            favoriPanel.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            favoriPanel.BackColor = Color.White;
            favoriPanel.Padding = new Padding(12);
            ...
            pnlContent.Controls.Add(favoriPanel);
            ...
            son.Location = new Point(margin, 468);
            pnlContent.Controls.Add(son);

            DataGridView grid = TemelGrid();
            grid.Location = new Point(margin, 510);
            grid.Size = new Size(availableWidth, 300);
